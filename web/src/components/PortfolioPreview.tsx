...
export default function PortfolioPreview({ isDark, language = 'en' }: PortfolioPreviewProps) {
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="opacity-90">{t.profileRole}</p>
          ...
          <div className="p-6 grid grid-cols-3 gap-4">
            <div className={`text-center p-4 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
              ...
              <div className="text-sm text-gray-500">{t.statsCommits}</div>
            </div>
            <div className={`text-center p-4 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
              <div className="text-2xl font-bold text-green-600">89</div>
              <div className="text-sm text-gray-500">{t.statsPRs}</div>
            </div>
            <div className={`text-center p-4 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
              <div className="text-2xl font-bold text-purple-600">156</div>
              <div className="text-sm text-gray-500">{t.statsStars}</div>
            </div>
          </div>

          {/* Top Projects */}
          <div className="p-6 border-t">
            <h4 className="font-semibold mb-4">{t.featuredProjects}</h4>
            <div className="space-y-3">
              <div className={`p-3 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                <div className="flex justify-between items-start">
                  <div>
                    <div className="font-medium">awesome-react-app</div>
                    <div className="text-sm text-gray-500">{t.projectDesc1}</div>
              ...
              <div className={`p-3 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">{t.projectDesc2}</div>
                    <div className="flex items-center space-x-3 mt-2 text-sm">
                      <span className="flex items-center">
        ...
        >
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-semibold mb-2">{t.features.autoGenerated.title}</h3>
              <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                {t.features.autoGenerated.description}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-semibold mb-2">{t.features.visualizations.title}</h3>
              <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                {t.features.visualizations.description}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-semibold mb-2">{t.features.skillTracking.title}</h3>
              <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                {t.features.skillTracking.description}
              </p>
            </div>
          </div>
          ...
          <div className={`p-6 rounded-xl ${isDark ? 'bg-gradient-to-r from-blue-900 to-purple-900' : 'bg-gradient-to-r from-blue-50 to-purple-50'} border border-blue-600/20`}>
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-semibold mb-1">{t.ctaTitle}</h4>
                <p className="text-sm opacity-90">{t.ctaSubtitle}</p>
              </div>
