      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow px-8 py-10">
          ...
          <div className="prose max-w-none text-gray-800">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-gray-900">2. 情報の利用目的</h2>
              <p className="text-gray-700 leading-relaxed">収集した情報は以下の目的で利用します：</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>サービスの提供・運営</li>
                <li>ユーザーサポート</li>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-gray-900">4. 第三者への提供</h2>
              <p className="text-gray-700 leading-relaxed">以下の場合を除き、個人情報を第三者に提供することはありません：</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>ユーザーの同意がある場合</li>
                <li>法令に基づく場合</li>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-gray-900">5. 外部サービスの利用</h2>
              <p className="text-gray-700 leading-relaxed">本サービスは以下の外部サービスを利用しています：</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-gray-900">7. データの削除</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4 text-gray-900">9. 改定</h2>
              <p className="text-gray-700 leading-relaxed">本ポリシーは、必要に応じて改定されることがあります。重要な変更がある場合は、サービス内でお知らせします。</p>
            </section>
          </div>
