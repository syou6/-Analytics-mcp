        ...
        <div className="bg-white rounded-lg shadow px-8 py-10">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>本規約は、GitVue（以下「本サービス」）の利用条件を定めるものです。ユーザーの皆様には、本規約に従って本サービスをご利用いただきます。</p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4">第3条（料金および支払方法）</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4">第4条（キャンセル・返金）</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p>本サービスに起因してユーザーに生じたあらゆる損害について、当社は一切の責任を負いません。ただし、当社の故意または重大な過失による場合を除きます。</p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4">第7条（サービス内容の変更等）</h2>
              <p>当社は、ユーザーに通知することなく、本サービスの内容を変更または提供を中止することができるものとします。</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>本規約は日本法に準拠し、本規約に起因する紛争は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
            </section>
          </div>
